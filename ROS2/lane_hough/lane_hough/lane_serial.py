...
class Serial(Node):
    ...
    def __init__(self):
        ...
        #         self.get_logger().warn("Port is not connnected. \n{}".format(e))
        #         # exit()
        #     time.sleep(1)
        #     print("waiting Port connect...")
        # if self.ser.is_open:  
        #     self.get_logger().info(self.ser.portstr)
        # else:
    ...
    def __del__(self):
        self.op = str(0)+"," + str(25)+",g,0,test_message &"
    ...
    def serial_callback(self, data):
        ...
        if b > 25:
            b = 25
        if a >= 0:
            self.op = str(abs(a))+"," + str(25-b)+",g,0,test_message &"
        
        elif a < 0:
            self.op = str(abs(a))+"," + str(25-b)+",b,0,test_message &"
